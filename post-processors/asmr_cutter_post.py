# -*- coding: utf-8 -*-
# ***************************************************************************
# *   Copyright (c) 2023 ASMR Systems <wellnessvoid@gmail.com>              *
# *                                                                         *
...
TOOLTIP = '''
This is a postprocessor file for the Path workbench. It is used to take a
pseudo-gcode fragment output by a Path object, and output real gcode suitable
for the Shapeoko 5 Pro cnc router @ASMR-LABS. This postprocessor, once placed
in the appropriate PathScripts dir or in your ~/.FreeCAD/Macro dir, can be used
directly from inside FreeCAD via the GUI importer or via python scripts with:

import asmr_cutter_post
asmr_cutter_post.export(objects, "/path/to/file.nc", "")
